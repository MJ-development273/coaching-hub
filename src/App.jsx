...
function MatchReportBuilder({ form, weekNum, onSaveReport }) {
  ...
  const generateImage = async () => {
    ...
    // ── Footer: sponsor strip only ──
    ctx.font = '24px sans-serif'
    ctx.fillStyle = 'rgba(255,255,255,0.8)'
    ctx.fillText('Proudly sponsored by [Sponsor Name]', W/2, H - 60)
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-4">
        ...
        <p className="text-xs text-gray-400 mt-3">🏷️ Club logo added. Sponsor strip is still a placeholder -- send over a sponsor logo whenever you're ready.</p>
      </div>
    </div>
  )
}
